...
const PASOS: Paso[] = [
  ...
  },
  {
    ...
    desc: 'Pulsa "Generar ✨" para elegir tipo de cocina (mediterránea, asiática, vegetariana…), días de la semana, comidas (comida, cena o ambas) y nivel de dificultad. La IA crea recetas reales con ingredientes y calorías.',
    chips: ['🍽️ Cocina a elegir', '📅 Días flexibles', '⚡ 10 segundos'],
    selector: '[data-tutorial="generar-btn"]',
  },
  {
    ruta: '/menu',
    emoji: '⭐',
    titulo: 'Controla cada receta',
    desc: 'En cada tarjeta: guarda favoritas ⭐ para que la IA las repita, pide una alternativa ➕ para elegir entre dos opciones, o marca 👎 lo que no te gusta para que la IA lo evite siempre.',
    chips: ['⭐ Favoritas', '➕ Alternativa', '👎 No me gusta'],
    selector: '[data-tutorial="receta-acciones"]',
  },
  {
    ruta: '/menu',
    emoji: '📖',
    titulo: 'Pasos de cocina detallados',
    desc: 'Pulsa "📖 Ver receta" en cualquier tarjeta para ver los pasos completos de cocina, generados por la IA al momento. Perfectos para cocinar sin perder detalle.',
    chips: ['👨‍🍳 Paso a paso', '⏱ Tiempo exacto', '🔥 Calorías'],
    selector: '[data-tutorial="ver-receta"]',
  },
  {
    ruta: '/lista',
    emoji: '🛒',
    titulo: 'Tu lista se genera sola',
    desc: 'Los ingredientes de todas tus recetas aparecen aquí automáticamente, agrupados por categoría con precio real de Mercadona. El total se calcula al instante.',
    chips: ['📋 Auto-generada', '💰 Precios reales', '🏷️ Por categoría'],
    selector: '[data-tutorial="menu-semana"]',
    clickBefore: '[data-tutorial="menu-semana-btn"]',
    scrollTo: true,
  },
  {
    ruta: '/lista',
    emoji: '✅',
    titulo: 'Marca lo que vas comprando',
    desc: 'Toca cualquier producto para marcarlo como comprado — aparece tachado y se mueve al final. Ajusta cantidades con los botones + / − o cambia entre unidades y kilos.',
    chips: ['☑️ Comprado', '⚖️ Cantidad', '📦 ud / kg'],
  ...
  },
  {
    ...
    desc: 'Pulsa 🏠 junto a un ingrediente para marcarlo como "en casa". Se descuenta del presupuesto y la IA no te lo pondrá en el carrito la próxima semana.',
    chips: ['🏠 En casa', '💸 Ahorro automático', '🔄 Se recuerda'],
  ...
  },
  {
    ruta: '/lista',
    emoji: '🔍',
    titulo: 'Catálogo de 4.600 productos',
    desc: 'Busca cualquier producto del catálogo de Mercadona y añádelo con precio real. O escribe algo que no esté en el catálogo y ponle precio manualmente.',
    chips: ['4.600 productos', '💰 Precio real', '✏️ Manual'],
  ...
  },
  {
    ruta: '/lista',
    emoji: '💰',
    titulo: 'Presupuesto en tiempo real',
    desc: 'El total de la compra se calcula en tiempo real con precios de Mercadona. Pulsa en el total (derecha) para fijar un límite semanal — la app te avisa si te pasas.',
    chips: ['📊 Tiempo real', '⚠️ Aviso límite', '🎯 Presupuesto'],
    selector: '[data-tutorial="lista-cabecera"]',
  },
  {
    ruta: '/lista',
